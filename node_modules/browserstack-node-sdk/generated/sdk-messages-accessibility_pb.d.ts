...
export class Accessibility extends jspb.Message {
  ...
  hasIsAppAccessibility(): boolean;
  clearIsAppAccessibility(): void;
  getIsAppAccessibility(): boolean;
  setIsAppAccessibility(value: boolean): void;
...
export class AccessibilityConfigRequest extends jspb.Message {
  ...
  hasTestIdentifier(): boolean;
  clearTestIdentifier(): void;
  getTestIdentifier(): string;
  setTestIdentifier(value: string): void;
...
export class AccessibilityResultRequest extends jspb.Message {
  getBinSessionId(): string;
  setBinSessionId(value: string): void;

  getTestRunId(): string;
  setTestRunId(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AccessibilityResultRequest.AsObject;
  static toObject(includeInstance: boolean, msg: AccessibilityResultRequest): AccessibilityResultRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: AccessibilityResultRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AccessibilityResultRequest;
  static deserializeBinaryFromReader(message: AccessibilityResultRequest, reader: jspb.BinaryReader): AccessibilityResultRequest;
}

export namespace AccessibilityResultRequest {
  export type AsObject = {
    binSessionId: string,
    testRunId: string,
    sessionId: string,
...
export class AccessibilityResultResponse extends jspb.Message {
  getSuccess(): boolean;
  setSuccess(value: boolean): void;

  getResultResponse(): Uint8Array | string;
  getResultResponse_asU8(): Uint8Array;
  getResultResponse_asB64(): string;
  setResultResponse(value: Uint8Array | string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AccessibilityResultResponse.AsObject;
  static toObject(includeInstance: boolean, msg: AccessibilityResultResponse): AccessibilityResultResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: AccessibilityResultResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AccessibilityResultResponse;
  static deserializeBinaryFromReader(message: AccessibilityResultResponse, reader: jspb.BinaryReader): AccessibilityResultResponse;
}

export namespace AccessibilityResultResponse {
  export type AsObject = {
    success: boolean,
    resultResponse: Uint8Array | string,
  }
}
