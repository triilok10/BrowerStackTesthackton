 ...
 */
const gapicConfig = require("./tag_keys_client_config.json");
...
class TagKeysClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listTagKeys: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'tagKeys'),
        };
        ...
        const createTagKeyResponse = protoFilesRoot.lookup('.google.cloud.resourcemanager.v3.TagKey');
        const createTagKeyMetadata = protoFilesRoot.lookup('.google.cloud.resourcemanager.v3.CreateTagKeyMetadata');
        const updateTagKeyResponse = protoFilesRoot.lookup('.google.cloud.resourcemanager.v3.TagKey');
        const updateTagKeyMetadata = protoFilesRoot.lookup('.google.cloud.resourcemanager.v3.UpdateTagKeyMetadata');
        const deleteTagKeyResponse = protoFilesRoot.lookup('.google.cloud.resourcemanager.v3.TagKey');
        const deleteTagKeyMetadata = protoFilesRoot.lookup('.google.cloud.resourcemanager.v3.DeleteTagKeyMetadata');
        this.descriptors.longrunning = {
            createTagKey: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createTagKeyResponse.decode.bind(createTagKeyResponse), createTagKeyMetadata.decode.bind(createTagKeyMetadata)),
            updateTagKey: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateTagKeyResponse.decode.bind(updateTagKeyResponse), updateTagKeyMetadata.decode.bind(updateTagKeyMetadata)),
            deleteTagKey: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteTagKeyResponse.decode.bind(deleteTagKeyResponse), deleteTagKeyMetadata.decode.bind(deleteTagKeyMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.resourcemanager.v3.TagKeys', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.tagKeysStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.resourcemanager.v3.TagKeys')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.resourcemanager.v3.TagKeys, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of tagKeysStubMethods) {
            const callPromise = this.tagKeysStub.then((stub) => (...args) => {
                if (this._terminated) {
    ...
    getTagKey(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    getNamespacedTagKey(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    createTagKey(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateTagKeyProgress(name) {
    ...
    updateTagKey(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateTagKeyProgress(name) {
    ...
    deleteTagKey(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteTagKeyProgress(name) {
    ...
    listTagKeys(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listTagKeysStream(request, options) {
        ...
        return this.descriptors.page.listTagKeys.createStream(this.innerApiCalls.listTagKeys, request, callSettings);
    }
    /**
    ...
    listTagKeysAsync(request, options) {
        ...
        return this.descriptors.page.listTagKeys.asyncIterate(this.innerApiCalls['listTagKeys'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=tag_keys_client.js.map