 ...
 */
const gapicConfig = require("./organizations_client_config.json");
...
class OrganizationsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            searchOrganizations: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'organizations'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.resourcemanager.v3.Organizations', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.organizationsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.resourcemanager.v3.Organizations')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.resourcemanager.v3.Organizations, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of organizationsStubMethods) {
            const callPromise = this.organizationsStub.then((stub) => (...args) => {
                if (this._terminated) {
    ...
    getOrganization(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    searchOrganizations(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    searchOrganizationsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.searchOrganizations.createStream(this.innerApiCalls.searchOrganizations, request, callSettings);
    }
    /**
     ...
     */
    searchOrganizationsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.searchOrganizations.asyncIterate(this.innerApiCalls['searchOrganizations'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=organizations_client.js.map