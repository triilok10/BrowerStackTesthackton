...
exports.TagBindingsClient = void 0;
 ...
 */
const gapicConfig = require("./tag_bindings_client_config.json");
...
class TagBindingsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listTagBindings: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'tagBindings'),
            listEffectiveTags: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'effectiveTags'),
        };
        ...
        const createTagBindingResponse = protoFilesRoot.lookup('.google.cloud.resourcemanager.v3.TagBinding');
        const createTagBindingMetadata = protoFilesRoot.lookup('.google.cloud.resourcemanager.v3.CreateTagBindingMetadata');
        const deleteTagBindingResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteTagBindingMetadata = protoFilesRoot.lookup('.google.cloud.resourcemanager.v3.DeleteTagBindingMetadata');
        this.descriptors.longrunning = {
            createTagBinding: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createTagBindingResponse.decode.bind(createTagBindingResponse), createTagBindingMetadata.decode.bind(createTagBindingMetadata)),
            deleteTagBinding: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteTagBindingResponse.decode.bind(deleteTagBindingResponse), deleteTagBindingMetadata.decode.bind(deleteTagBindingMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.resourcemanager.v3.TagBindings', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.tagBindingsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.resourcemanager.v3.TagBindings')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.resourcemanager.v3.TagBindings, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of tagBindingsStubMethods) {
            const callPromise = this.tagBindingsStub.then((stub) => (...args) => {
                if (this._terminated) {
    ...
    createTagBinding(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    async checkCreateTagBindingProgress(name) {
    ...
    deleteTagBinding(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteTagBindingProgress(name) {
    ...
    listTagBindings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listTagBindingsStream(request, options) {
        ...
        return this.descriptors.page.listTagBindings.createStream(this.innerApiCalls.listTagBindings, request, callSettings);
    }
    /**
    ...
    listTagBindingsAsync(request, options) {
        ...
        return this.descriptors.page.listTagBindings.asyncIterate(this.innerApiCalls['listTagBindings'], request, callSettings);
    }
    listEffectiveTags(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listEffectiveTagsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listEffectiveTags.createStream(this.innerApiCalls.listEffectiveTags, request, callSettings);
    }
    /**
     ...
     */
    listEffectiveTagsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listEffectiveTags.asyncIterate(this.innerApiCalls['listEffectiveTags'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=tag_bindings_client.js.map