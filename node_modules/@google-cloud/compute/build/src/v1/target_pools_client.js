...
class TargetPoolsClient {
    ...
    initialize() {
        ...
        const targetPoolsStubMethods = ['addHealthCheck', 'addInstance', 'aggregatedList', 'delete', 'get', 'getHealth', 'insert', 'list', 'removeHealthCheck', 'removeInstance', 'setBackup', 'setSecurityPolicy'];
