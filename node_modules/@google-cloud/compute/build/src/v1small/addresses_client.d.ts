...
export declare class AddressesClient {
     ...
     */
    aggregatedListAsync(request?: protos.google.cloud.compute.v1small.IAggregatedListAddressesRequest, options?: CallOptions): AsyncIterable<[string, protos.google.cloud.compute.v1small.IAddressesScopedList]>;
    /**
